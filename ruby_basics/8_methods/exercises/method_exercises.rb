...
def common_sports(current_sports_array, favorite_sports_array)
    current_sports_array.intersection(favorite_sports_array)
end
...
def pet_pun(animal_string)
    ...
    when "dog" 
        ...
        puts "I think #{animal_string}s have pet-tential!"
    end
    return nil
end
...
def twenty_first_century?(year_int)
    year_int.between?(2001, 2100)
end
