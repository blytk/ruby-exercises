...
def count_empty_seats(chart)
  ...
  flattened_chart = chart.flatten.filter {|element| element == nil}
  flattened_chart.length
end
...
def find_favorite(array_of_hash_objects)
  ...
  array_of_hash_objects.each_with_index do |array_element, array_index|
    if array_element[:is_my_favorite?] == true
